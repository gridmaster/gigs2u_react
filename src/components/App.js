...
class App extends React.Component {
  ...
  render() {
    ...
    const gigList = [
      ...
      { key: 3, link: "../images/gig4.jpg", event: "Get your tickets now!!", date: "2/26/2021" },
      { key: 3, link: "../images/gig5.jpg", event: "Come down to the Crossroads!", date: "3/5/2021" },
      { key: 3, link: "../images/gig6.jpg", event: "Live music all night long!", date: "3/10/2021" }
    ];
